...
<MobileElementEntity>
   ...
   <name>ACTIVATIONPAGE_LATER_TEXTLINK</name>
   <tag></tag>
   <elementGuidId>d42dd259-9e8f-48a8-8e7e-881a4da6022b</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Để sau' or . = 'Để sau')]</locator>
