...
<MobileElementEntity>
   ...
   <name>SIGNUPPAGE_EMAIL_TXTBOX</name>
   <tag></tag>
   <elementGuidId>b72254c1-0f9b-467d-8d38-e5ecd80a6343</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Nhập email của bạn' or . = 'Nhập email của bạn')]</locator>
